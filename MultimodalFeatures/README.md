...
This script generates a single file that includes, for each participant and infounit mentioned, a set of multimodal features. (e..g, latency of between mention and gaze on infunit "Boy")
